...
int isPositive(int x) {
  int signConvert = !(x >> 31);
  return !x^signConvert;
}
/* 
...
int isLessOrEqual(int x, int y) {
  ...
  return (diff & xSign) | (!(diff | valueSign));
}
/*
...
unsigned float_i2f(int x) {
  unsigned sign = 0, exp = 31, frac = 0, toAdd = 0;
  if (x == 0x00000000u)
    return 0x00000000u;
  if (x & 0x80000000u) {
    sign = 0x80000000u;
